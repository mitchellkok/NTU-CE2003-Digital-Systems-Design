...
HD_PWD='/media/mitchellkok/OS/Users/mitch/Desktop/Y2S2/CE2003 Digital Systems Design/Lab 5/Lab5/lab5/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uP16_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uP16_top.tcl
